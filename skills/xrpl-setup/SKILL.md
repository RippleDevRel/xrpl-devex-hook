...
- Yes: `TEAM_NAME="<their team, as typed>" CONSENT=yes node REPO/hook/setup.mjs --non-interactive --agent <the agent you are running as: claude-code, cursor, codex, grok or vscode-copilot>`
